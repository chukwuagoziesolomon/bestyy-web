...
import { Home, List, BarChart3, CreditCard, Menu, X, HelpCircle, Settings, Eye, EyeOff, Landmark, Calendar, ChevronDown } from 'lucide-react';
...
const MobileCourierPayout: React.FC = () => {
  ...
  // Sample payout data for courier
  const payoutData = {
          ...
          <>
            ...
            <div style={{
              ...
              <div style={{
                ...
                {payoutData.transactions.slice(0, 8).map((transaction) => (
