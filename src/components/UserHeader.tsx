...
const UserHeader: React.FC<UserHeaderProps> = ({ title, showHamburger = true }) => {
  const navigate = useNavigate();
  const [showMenu, setShowMenu] = useState(false);
  const { user } = useAuth();

  // Get user profile picture and name from localStorage
  let userProfilePic = '/logo.png';
  let userName = 'User';
  ...
  if (savedUser) {
    try {
      ...
      userName = userData.first_name || userData.full_name || userData.name || userName;
        ...
        <div style={{ 
          ...
          <div style={{
            ...
            <div style={{
              ...
              {userProfilePic && userProfilePic !== '/logo.png' ? (
                <img 
                  src={userProfilePic} 
